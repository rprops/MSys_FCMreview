...
```{r, include=TRUE}
fp_x <- flowFPModel(fcs = FCS_resample(flowData_transformed_asinh_dn, 1e3), parameters = param,
  nRecursions = 8)

# fp_x <- flowBasis(FCS_resample(flowData_transformed_asinh_dn, 1e3), param = param, nbin = 128)
